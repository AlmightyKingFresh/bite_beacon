defmodule BiteBeaconWeb.VendorAuth do
  ...
  the current_vendor:
      ...
      defmodule BiteBeaconWeb.PageLive do
        ...
        on_mount {BiteBeaconWeb.VendorAuth, :mount_current_vendor}
        ...
      end

  Or use the `live_session` of your router to invoke the on_mount callback:

      live_session :authenticated, on_mount: [{BiteBeaconWeb.VendorAuth, :ensure_authenticated}] do
