defmodule BiteBeaconWeb.UserAuth do
  ...
  the current_user:
      ...
      defmodule BiteBeaconWeb.PageLive do
        use BiteBeaconWeb, :live_view

        on_mount {BiteBeaconWeb.UserAuth, :mount_current_user}
        ...
      end

  Or use the `live_session` of your router to invoke the on_mount callback:

      live_session :authenticated, on_mount: [{BiteBeaconWeb.UserAuth, :ensure_authenticated}] do
